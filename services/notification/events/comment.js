...
comment.send = (from, to, feedId, commentId) => {
  return new Promise(async (resolve, reject) => {
    try{
      ...
      const payload = _createPayload(from, to, userMap, feedId, commentId);
...
const _createPayload = (from, to, userMap, feedId, commentId) => {
